  ...
  return (
    <React.Fragment>
      ...
      <p className="contact-paragraph">
        ...
        Please fill in your details below and we will use the information
        provided for customer service purposes. Please note that we respect your
        privacy and will only use your data for services purposes and will not
